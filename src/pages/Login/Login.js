        ...
        render={(formikProps) => (
          <Form className="lg:w-1/2 xl:max-w-screen-sm">
            <div className="mt-8 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
              ...
              <h2
                style={{ color: "#876800" }}
                className="text-4xl font-display font-semibold text-center xl:text-5xl
              xl:text-bold"
              >
                Đăng nhập
              </h2>
                ...
                <div>
                  <div className="mt-2">
                    ...
                    <Field
                      ...
                      className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-yellow-300"
                  ...
                  <div className="mt-10">
                    <button
                      ...
                      className="text-lg p-4 w-full rounded-full tracking-wide
