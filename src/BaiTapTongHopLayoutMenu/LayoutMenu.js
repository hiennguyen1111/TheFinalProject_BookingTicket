  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-6">
            ...
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              {mangDanhMuc.map((danhMuc, index) => {
                const classNameActive = [
                  ...
                  "space-x-3",
                  "rounded-md",
                  maDanhMuc === danhMuc.maDanhMuc ? "bg-purple-700 text-white" : "",
                ];
                return (
                  <li
        ...
        <section class="text-gray-600 body-font col-span-5">
                ...
                (item, index) => {
                  return (
                    <div class="p-4 lg:w-1/3">
                      <div class="h-full bg-purple-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <a
                          class="text-purple-500 inline-flex items-center cursor-pointer"
                          onClick={() => {
                            setOpenModal(true);
                            setItem(item);
                          }}
                        ...
                        <div class="text-right mt-2 leading-none flex justify-end absolute bottom-0 left-0 w-full py-4">
                          <span class="text-gray-400 mr-3 inline-flex items-center leading-none text-2xl pr-3 py-1">
                            Giá : {item.gia}
                          </span>
                        </div>
                      </div>
